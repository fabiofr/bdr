...
class ClientController extends AppController {
	...
	public function request_index(){
		...
		$link =  "http://" . $_SERVER['HTTP_HOST'] . $this->webroot.'rest_atividades.json';
	...
	public function request_view($id){
		...
		// remotely post the information to the server
		$link =  "http://" . $_SERVER['HTTP_HOST'] . $this->webroot.'rest_atividades/'.$id.'.json';
	...
	public function request_add(){
		...
		$data = null;
		$httpSocket = new HttpSocket();
		$data['Atividade']['titulo'] = 'Novo titulo';
		$data['Atividade']['descricao'] = 'Nova descricao';
		$data['Atividade']['prioridade'] = 'Nova prioridade';
